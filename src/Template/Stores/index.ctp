<div class="stores index white-bg z-depth-3">
	...
	<div class="wrapper">
		...
		<div class="search">
			...
			<div class="row">
				<div class="col l10">
					<?php echo $this->Form->input('search', array('placeholder' => __('Search by store name'), 'label' => false)); ?>
				</div>
		...
		<table class="bordered responsive-table highlight" cellpadding="0" cellspacing="0">
			<thead>
				<tr>
					...
					<th class="center-align"><?= $this->Paginator->sort('active zones') ?></th>
			...
			<tbody>
				...
				<tr>
					...
					<td><?= $this->Html->link(h($store->name), ['action' => 'view', $store->id]) ?></td>
					...
					<td class="center-align"><?= h($store->status ? __('Active') : __('Inactive')) ?></td>
